...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    navigationController1v2.tabBarItem = [[UITabBarItem alloc] initWithTitle:NSLocalizedString(@"TestRunner.title", nil) image:[UIImage imageNamed:@"SpeedTest"] tag:0];
    ...
    tabBarController.viewControllers = @[navigationController1v2, navigationController1, navigationController2, navigationController3];
